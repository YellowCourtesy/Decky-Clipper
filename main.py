...
class Plugin:
  ...
  async def start_record(self, app_name: str, microphone: bool):
    ...
    videopipeline = "pipewiresrc do-timestamp=true target-object=gamescope client-name=Video-capture keepalive-time=33 ! video/x-raw ! videoconvert ! vah264enc ! h264parse ! mux. "
