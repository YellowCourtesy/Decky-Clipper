...
class Plugin:
  ...
  async def start_record(self, app_name: str, microphone: bool):
    ...
    videopipeline = "pipewiresrc do-timestamp=true target-object=gamescope client-name=Video-capture ! queue ! videorate ! video/x-raw,format=NV12,framerate=60/1 ! videoconvert ! vah265enc rate-control=vbr bitrate=5000 target-percentage=50 ! h265parse ! mux. "
