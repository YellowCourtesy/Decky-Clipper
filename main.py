...
class Plugin:
  ...
  async def start_record(self, app_name: str, microphone: bool):
    ...
    videopipeline = "pipewiresrc do-timestamp=true target-object=gamescope client-name=Video-capture ! videoconvert ! vah264enc rate-control=vbr bitrate=5000 target-percentage=60 ! h264parse ! mux. "
